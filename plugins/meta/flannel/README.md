...
This plugin supports delegating to the windows CNI plugins (win-overlay, win-l2bridge) to work in conjunction with [Flannel on Windows](https://github.com/coreos/flannel/issues/833). 

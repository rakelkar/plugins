...
type EndpointCreatorFunc func() (*hcsshim.HNSEndpoint, error)

func ProvisionEndpoint(epName string, expectedNetworkId string, containerID string, endpointCreator EndpointCreatorFunc) (*hcsshim.HNSEndpoint, error) {
	...
	if createEndpoint {
		...
		if hnsEndpoint, err = endpointCreator(); err != nil {
			return nil, err
		}
	}
